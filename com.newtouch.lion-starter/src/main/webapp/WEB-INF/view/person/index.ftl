...
<!--demo-->
<script src="${base}/resources/demo/js/person.js" type="text/javascript"></script>
</head>
		...
		<div class="row">
			  <div class="col-md-12 margin-bottom-10">
				<form id="queryform" class="form-horizontal">
					...
					<div class="col-md-3">
						<input class="form-control input-small" type="text" size="30" name="name" id="name"  placeholder="<@spring.message "sys.group.form.namezh.missing.message"/>"/>					
					</div>
					<div class="col-md-7">
			...
			<div class="col-md-12">
				<table class="lion-datagrids table table-striped table-bordered table-hover" id="sys_group_list_tb" data-singleselect="true",   data-loadUrl="${base}/person/list.json" data-checkbox="true" data-pageSize="10">
					<thead>
						<tr>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group">
								<input type="text"  name="name"  maxlength="100" class="form-control" placeholder='<@spring.message "sys.group.form.namezh.missing.message"/>' size="30"/>
							</div>
						</div>
					</div>
					<div class="form-group">
